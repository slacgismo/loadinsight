...
DEVICE_MAP = rbsa.create_data(name="DEVICE_MAP", reader=config_reader)
device_map = rbsa.create_data(name="device_map")
site_loads = rbsa.create_data(name="site_loads")
zipcode_map = rbsa.create_data(name="zipcode_map")
site_loads = rbsa.create_data(name="site_loads")
area_loads = rbsa.create_data(name="area_loads")
NOAA_DATA = rbsa.create_data(name="NOAA_DATA", reader=config_reader)
NOAA_data = rbsa.create_data(name="NOAA_data")
heat_cool_index = rbsa.create_data(name="heat_cool_index")
enduse_loads = rbsa.create_data(name="enduse_loads")
GAS_FRACTIONS = rbsa.create_data(name="GAS_FRACTIONS", reader=config_reader)
gas_fractions = rbsa.create_data(name="gas_fractions")
total_loads = rbsa.create_data(name="total_loads")
LOAD_NORMALIZATION_RULES = rbsa.create_data(name="LOAD_NORMALIZATION_RULES", reader=config_reader)
normalization_rules = rbsa.create_data(name="normalization_rules")
normal_loads = rbsa.create_data(name="normal_loads")
tmy_data = rbsa.create_data(name="tmy_data")
loadshapes = rbsa.create_data(name="loadshapes")
total_loadshapes = rbsa.create_data(name="total_loadshapes")
TMY_DATA = rbsa.create_data(name="TMY_DATA", reader=config_reader)
gas_fractions = rbsa.create_data(name="gas_fractions")
enduse_loadshapes = rbsa.create_data(name="enduse_loadshapes")
normalization_rules = rbsa.create_data(name="normalization_rules")
normal_loadshapes = rbsa.create_data(name="normal_loadshapes")
DAYTYPE_DEFINITIONS = rbsa.create_data(name="DAYTYPE_DEFINITIONS", reader=config_reader)
daytype_definitions = rbsa.create_data(name="daytype_definitions")
residential_composition = rbsa.create_data(name="residential_composition")
