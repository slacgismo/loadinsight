...
from backend.models import CustomUser, ExampleUser
from backend.tests.common import create_user, mock, perform_create_mock
...
class UserCreateViewTest(
    ...
    @override_settings(AUTH_USER_MODEL="backend.CustomUser")
    ...
    @override_settings(AUTH_USER_MODEL="backend.ExampleUser")
