...
class DiscountGas(t.Task):
    ...
    def __init__(self, name, pipeline_artifact_dir):
        ...
        self.input_artifact_total_loadshapes = f'{pipeline_artifact_dir}/total_loadshapes.csv'
        ...
        self.output_artifact_enduse_loadshapes = f'{pipeline_artifact_dir}/enduse_loadshapes.csv'
