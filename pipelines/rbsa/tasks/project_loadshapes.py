...
class ProjectLoadshapes(t.Task):
    ...
    def __init__(self, name, pipeline_artifact_dir):
        ...
        self.input_artifact_loadshapes = f'{pipeline_artifact_dir}/loadshapes.csv'
        self.input_artifact_correlation_matrix = f'{pipeline_artifact_dir}/correlation_matrix.csv'
        ...
        self.output_artifact_total_loadshapes = f'{pipeline_artifact_dir}/total_loadshapes.csv'
    ...
    def _task(self):
        ...
        for target in target_locations:
            ...
            try:
                weather_filename = f'{self.pipeline_artifact_dir}/tony_output_updated/{str(target)}.csv'
