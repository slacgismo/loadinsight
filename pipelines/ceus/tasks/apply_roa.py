...
class ApplyRoa(t.Task):
    ...
    def __init__(self, name):
        super().__init__(self)
        self.name = name
        self.input_artifact_roa_com = 'roa_com.csv'
        self.input_artifact_normal_loadshapes = 'ceus_normal_loadshapes.csv'
        self.output_artifact_components = 'ceus_components.csv'
        self.my_data_files = [
