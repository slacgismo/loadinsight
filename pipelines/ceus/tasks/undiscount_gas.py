...
class UndiscountGas(t.Task):
    ...
    def __init__(self, name, pipeline_artifact_dir):
        ...
        self.input_artifact_ceus_cleandata = f'{pipeline_artifact_dir}/ceus_cleandata.csv'
        ...
        self.output_artifact_total_loads = f'{pipeline_artifact_dir}/ceus_total_loads.csv'
