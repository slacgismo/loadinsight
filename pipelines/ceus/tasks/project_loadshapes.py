...
class ProjectLoadshapes(t.Task):
    ...
    def _task(self):
        ...
        for target in target_locations:
            ...
            try:
                weather_file = [{ 'name': f'{self.pipeline_artifact_dir}/tony_output_updated/{str(target)}.csv', 'read_type': SupportedFileReadType.DATA }] 
                weather = self.load_data(weather_file)[f'{self.pipeline_artifact_dir}/tony_output_updated/{str(target)}.csv']
            except:
